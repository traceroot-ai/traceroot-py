...
def test_using_attributes_applies_to_native_otel_spans():
    ...
    with using_attributes(session_id="room-123", user_id="user-456"):
        with tracer.start_as_current_span("livekit-native-span"):
            pass
